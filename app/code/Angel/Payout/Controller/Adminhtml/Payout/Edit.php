...
class Edit extends \Angel\Payout\Controller\Adminhtml\Payout
{
    ...
    public function execute()
    {
        ...
        $this->initPage($resultPage)->addBreadcrumb(
            $id ? __('Edit Payout') : __('New Payout'),
            $id ? __('Edit Payout') : __('New Payout')
        );
        $resultPage->getConfig()->getTitle()->prepend(__('Payouts'));
        $resultPage->getConfig()->getTitle()->prepend($model->getId() ? __('Edit Payout %1', $model->getId()) : __('New Payout'));
        return $resultPage;
    }
}
